    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="features" element={<div className="container mx-auto p-8">Features Page</div>} />
          ...
          <Route path="*" element={<div className="container mx-auto p-8">404 - Page Not Found</div>} />
        </Route>
      </Routes>
    </BrowserRouter>
  )
