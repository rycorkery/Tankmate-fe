...
export function TankDetail() {
  ...
  const {
    data: inhabitantsData,
    isLoading: inhabitantsLoading,
    refetch: refetchInhabitants,
  } = useGetTankInhabitants(
    id || '',
    {
  ...
  const allParameters: Parameter[] = (parametersData?.content || []).map((param) => ({
    id: param.id || '',
    type: param.type as CreateParameterRequestType, // Cast to the expected enum type
    value: param.value || 0,
  ...
  const { parametersToShow, uniqueDaysCount, hasMoreDays } = useMemo(() => {
    if (allParameters.length === 0)
      return { parametersToShow: [], uniqueDaysCount: 0, hasMoreDays: false }
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          {tank.description && <p className="text-slate-600 mt-2 mb-3">{tank.description}</p>}
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-slate-200 text-slate-800">
              <svg className="w-3 h-3 mr-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path
                  fillRule="evenodd"
                  d="M10 2s-4 4.5-4 8a4 4 0 008 0c0-3.5-4-8-4-8z"
                  clipRule="evenodd"
                />
              </svg>
            ...
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-slate-200 text-slate-800">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M4 8V6a2 2 0 012-2h2M4 16v2a2 2 0 002 2h2m8-16h2a2 2 0 012 2v2m-4 12h2a2 2 0 002-2v-2M9 12h6m-6 4h6m2-10V4m0 2-2-2m2 2l2-2"
                />
              </svg>
              30″×12″×12″
            </span>
        ...
        <div className="lg:col-span-1">
          <TankmateCard className="h-full">
            ...
            <TankmateCardContent>
              ...
              <TankmateButton variant={ButtonVariant.OUTLINE} className="w-full mt-4">
                Add Photos
              </TankmateButton>
            </TankmateCardContent>
          </TankmateCard>
        ...
        <TankmateCard>
          ...
          <TankmateCardContent>
            {inhabitantsLoading ? (
              ...
              <div className="text-center py-4 text-slate-600">No inhabitants added yet</div>
            ) : (
          ...
          <TankmateCardContent className="flex-1 flex flex-col">
            <div className="flex-1">
              {parametersLoading ? (
                ...
                <div className="text-center py-4 text-slate-600">No parameters recorded yet</div>
              ) : (
                <>
        ...
        <TankmateCard>
          ...
          <TankmateCardContent>
            {eventsLoading ? (
              ...
              <div className="text-center py-4 text-slate-600">No activities recorded yet</div>
            ) : (
